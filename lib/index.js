...
const dwarfProto = grpc.loadPackageDefinition(proto_loader_1.loadSync(PROTO_PATH)).pb;
if (!GRPC_SERVER) {
...
function shorten(urls) {
    return new Promise((resolve, reject) => {
        const client = new dwarfProto.Dwarf(GRPC_SERVER, grpc.credentials.createInsecure());
